...
function UGSlider(){
	...
	var g_options = {
		  ...
		  slider_background_opacity: 0.85,				//slider background opacity
...
function UGLightbox(){
	...
	var g_options = {
			...
			lightbox_overlay_opacity:0.75,						//the opacity of the overlay. if null - will take from css
